...
export default function Landing() {
  ...
  async function quickLogin(email) {
    try {
      ...
      alert('Demo login failed. The backend may be waking up — try again in 30 seconds.\n\n' + e.message);
    }
  }
          ...
          <div className="text-center max-w-4xl mx-auto animate-slide-up">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center items-center">
              ...
              <button
                ...
                className="group inline-flex items-center gap-2 bg-white text-slate-900 px-7 py-3.5 rounded-xl font-semibold shadow border-2 border-slate-200 hover:border-slate-400 transition-all"
              >
                Try as HR Admin
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>
              ...
              <div className="relative bg-white rounded-2xl shadow-xl border border-slate-200 p-5">
                <div className="bg-violet-50 border border-violet-200 rounded-xl p-4">
                  ...
                  <ol className="space-y-2.5">
                    {[
                      { ok: true,  reason: 'Check user leave balance',      summary: 'Annual: 17 days remaining' },
                      { ok: true,  reason: 'Look up Diwali 2026 date',       summary: 'October 22 (Thursday)' },
                      { ok: true,  reason: 'Check team capacity',            summary: 'No major conflicts' },
                      { ok: true,  reason: 'Draft 5-day annual leave',       summary: 'Oct 19 – Oct 23' },
                    ].map((s, i) => (
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-violet-900 to-indigo-900 rounded-3xl p-10 sm:p-16 text-center shadow-2xl">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                <button
                  onClick={() => quickLogin('rahul@xyzcorp.com')}
                  className="group inline-flex items-center gap-2 bg-white text-slate-900 px-7 py-3.5 rounded-xl font-semibold shadow-xl hover:scale-105 transition-transform"
                >
                  Try as Employee
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </button>
                <button
                  onClick={() => quickLogin('priya.hr@xyzcorp.com')}
                  className="group inline-flex items-center gap-2 bg-violet-700 text-white px-7 py-3.5 rounded-xl font-semibold shadow-xl hover:bg-violet-600 transition-colors"
                >
                  Try as HR Admin
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </button>
